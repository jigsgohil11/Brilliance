...
function InitTaskCloning() {
    ...
    try {
        ...
        $('.main-multi-field-wrapper').each(function () {
            ...
            $(".add-task", $this).click(function (e) {
                ...
                $clone.clone().appendTo($wrapper).find('input,textarea,radio,select').each(function () {
                    /// $len = $len + 1;
                    debugger;
            ...
            $($wrapper).on("click", ".multi-field .remove-task", function (e) {
